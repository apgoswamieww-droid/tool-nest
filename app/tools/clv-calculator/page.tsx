...
const FAQ = [
  { question: "What is Customer Lifetime Value (CLV)?", answer: "CLV is the total revenue a business can expect from a single customer throughout their entire relationship. It helps determine how much to invest in acquiring and retaining customers." },
  { question: "What's the difference between basic and adjusted CLV?", answer: "Basic CLV = Average Purchase Value × Frequency × Lifespan. Adjusted CLV factors in gross margin, retention rate, and discount rate for a more accurate prediction." },
  { question: "What is a good CLV:CAC ratio?", answer: "A CLV:CAC ratio of 3:1 or higher is considered healthy. This means you earn $3 for every $1 spent acquiring a customer. Below 1:1 means you're losing money." },
  { question: "How do I improve CLV?", answer: "Improve CLV by increasing purchase frequency (upselling, cross-selling), increasing average order value, improving customer retention (loyalty programs, better service), and reducing churn." },
];
