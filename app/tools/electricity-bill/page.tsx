...
const FAQ = [
  { question: "How do I estimate my electricity bill?", answer: "Add your appliances with their wattage and daily usage hours. Enter your electricity rate (per kWh). The tool calculates your estimated daily, monthly, and yearly electricity cost." },
  { question: "Where do I find my electricity rate?", answer: "Check your utility bill for the rate per kWh. In the US, the average is about $0.16/kWh. Rates vary by region and usage tier." },
  { question: "How accurate is this calculator?", answer: "It provides a close estimate based on appliance wattage and usage time. Actual consumption may vary based on appliance efficiency, age, temperature settings, and usage patterns." },
  { question: "How can I reduce my electricity bill?", answer: "Key tips: switch to LED bulbs, use energy-efficient appliances, adjust thermostat settings, unplug idle electronics, use power strips, and run heavy appliances during off-peak hours." },
];
