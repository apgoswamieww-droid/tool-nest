...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "A robots.txt file is a text file placed at the root of your website that tells search engine crawlers which pages they can or cannot access. It's part of the Robots Exclusion Protocol.",
  },
  {
    question: "Where should I place the robots.txt file?",
    answer:
      "The robots.txt file should be placed at the root of your domain (e.g., https://example.com/robots.txt). Search engine crawlers always look for it at this location.",
  },
  {
    question: "Does robots.txt block all bots?",
    answer:
      "No. The robots.txt file relies on voluntary compliance. Well-behaved bots (Googlebot, Bingbot) will respect it, but malicious bots may ignore it. For true access control, use server-side authentication or IP blocking.",
  },
  {
    question: "What should I put in my robots.txt?",
    answer:
      "A basic robots.txt allows all crawlers to access your entire site. Add Disallow rules for admin pages, private areas, or pages you don't want indexed. Always include your sitemap URL.",
  },
];
