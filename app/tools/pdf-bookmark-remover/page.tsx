...
const FAQ = [
  { question: "What are PDF bookmarks?", answer: "Bookmarks (also called outlines) are the navigation tree in a PDF's sidebar that lets readers jump to specific sections or pages." },
  { question: "Why remove bookmarks?", answer: "When sharing documents, bookmarks may reveal internal structure, sensitive section names, or editing history. Removing them creates a clean, simplified document." },
  { question: "Does this affect page content?", answer: "No. Only the bookmark/outline navigation tree is removed. All page content, text, images, and formatting remain intact." },
];
