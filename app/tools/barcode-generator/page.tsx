...
const FAQ = [
  { question: "What is Code128?", answer: "Code128 is a high-density barcode symbology that can encode all 128 ASCII characters. It's widely used in logistics, shipping labels, and inventory management." },
  { question: "How do I download the barcode?", answer: "Click the 'Download SVG' button to save the barcode as a scalable vector file. SVG format ensures the barcode remains sharp at any size." },
  { question: "What can I encode?", answer: "Code128 supports all ASCII characters: letters, numbers, symbols, and control characters. Maximum practical length is about 80 characters." },
  { question: "Is this barcode scannable?", answer: "Yes! The generated barcodes follow the Code128-B standard and can be scanned by any standard barcode scanner." },
];
