...
const FAQ = [
  { question: "How much paint do I need?", answer: "Enter your room dimensions, number of doors and windows, coats of paint, and price per gallon. The calculator determines the paintable area and exact gallons needed." },
  { question: "How many coats of paint should I apply?", answer: "Most surfaces need 2 coats for even coverage and durability. One coat may suffice for same-color repaints or high-quality paints with built-in primer." },
  { question: "What's the average paint coverage?", answer: "Standard paint covers about 350 sq ft per gallon. Primer covers about 200-300 sq ft. Coverage varies by surface texture, paint type, and application method." },
  { question: "Should I include the ceiling?", answer: "Check the 'Include ceiling' option if you're painting it too. This adds the ceiling area (Length × Width) to the total calculation." },
];
