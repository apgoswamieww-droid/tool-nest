...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Enter the total number of classes held so far and how many you've attended. The tool instantly calculates your attendance percentage.",
  },
  {
    question: "What is the minimum attendance requirement?",
    answer:
      "Most educational institutions require 75% attendance. You can set a custom target percentage (e.g., 75%, 80%) to see how many more classes you need to attend.",
  },
  {
    question: "How many more classes do I need to attend?",
    answer:
      "The tool tells you exactly how many additional classes you must attend to reach your target percentage. It also shows how many classes you can still miss.",
  },
  {
    question: "Can I use this for college and school?",
    answer:
      "Yes! This calculator works for any attendance tracking system — school, college, coaching classes, or any training program with minimum attendance requirements.",
  },
];
