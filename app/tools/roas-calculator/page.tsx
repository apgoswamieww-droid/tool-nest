...
const FAQ = [
  { question: "What is ROAS?", answer: "ROAS (Return on Ad Spend) measures how much revenue you earn for every dollar spent on advertising. A ROAS of 4 means you earn $4 for every $1 spent on ads." },
  { question: "What is a good ROAS?", answer: "A ROAS of 3:1 or higher is generally considered good. However, the ideal ROAS depends on your profit margins, business model, and industry benchmarks." },
  { question: "How is ROAS different from ROI?", answer: "ROAS only considers ad spend vs. revenue. ROI considers all costs (including operating expenses, overhead, etc.) and calculates overall profitability." },
  { question: "Should I include other costs in the ROAS calculation?", answer: "Standard ROAS only uses ad spend. For a fuller picture, enter your total costs in the optional field to see your true ROI alongside ROAS." },
];
