...
const FAQ = [
  { question: "What is working capital?", answer: "Working capital is the difference between a company's current assets and current liabilities. It measures a business's ability to meet its short-term obligations." },
  { question: "What is a good current ratio?", answer: "A current ratio of 1.5 to 2.0 is generally considered healthy. Below 1.0 indicates the business may struggle to pay short-term debts. Above 2.0 may indicate inefficient use of assets." },
  { question: "What is the quick ratio?", answer: "The quick ratio (or acid-test ratio) is like the current ratio but excludes inventory and prepaid expenses. It gives a more conservative view of short-term liquidity." },
  { question: "How do I improve working capital?", answer: "Improve by: accelerating receivables collection, managing inventory levels, negotiating longer payment terms with suppliers, or securing a line of credit." },
];
