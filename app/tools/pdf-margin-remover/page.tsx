...
const FAQ = [
  { question: "How do margins work in PDF?", answer: "PDF margins are controlled by the MediaBox (total page) and CropBox (visible area). This tool sets the CropBox to trim unwanted white space around the content." },
  { question: "What margin values should I use?", answer: "Start with small values (20-30 points ≈ 0.3-0.4 inches). Common adjustments: 36pt for 0.5in trim, 72pt for 1in trim. Preview results before printing." },
  { question: "Does this reduce file size?", answer: "Margin trimming may slightly reduce file size since the visible area is smaller, but the main benefit is visual — more content visible per page when printed." },
];
