...
const FAQ = [
  { question: "How do I calculate concrete for a slab?", answer: "Enter length, width, and depth (thickness) in feet. The calculator gives volume in cubic feet, yards, and meters, plus the number of bags needed." },
  { question: "What size are concrete bags?", answer: "Standard bags are 0.6 cubic feet (60 lb) or 0.45 cubic feet (50 lb). The default is 0.6 cu ft per bag." },
  { question: "Why add wastage?", answer: "Spillage, uneven ground, and over-excavation mean you typically need 5-10% more concrete than the exact volume." },
];
