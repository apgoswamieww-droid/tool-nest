...
const FAQ = [
  { question: "What is the Pomodoro Technique?", answer: "It's a time management method: work for 25 minutes, take a 5-minute break, repeat. After 4 cycles, take a longer 15-minute break." },
  { question: "Can I customize the durations?", answer: "This version uses standard Pomodoro timings (25/5/15 minutes). You can reset the timer at any point." },
  { question: "Does it play a sound?", answer: "The timer shows visual alerts when sessions end. Sound alerts may vary by browser settings." },
];
