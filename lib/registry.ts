...
export const TOOL_REGISTRY: Tool[] = [
  ...
  { slug: "hash-generator", name: "Hash Generator", description: "Generate MD5, SHA-1, SHA-256 hashes from any text.", icon: KeyRound, category: "developer-tools", tags: ["hash", "md5", "sha", "encrypt"], featured: true },
