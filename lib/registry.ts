...
export const TOOL_REGISTRY: Tool[] = [
  ...
  // ── Developer Tools ─────────────────────────────
  { slug: "json-formatter", name: "JSON Formatter", description: "Beautify, minify, and validate JSON data.", icon: Binary, category: "developer-tools", tags: ["json", "format", "beautify", "validate"], featured: true, tier: "premium", premiumFeatures: ["Format & validate with precise line/column errors", "Minify for production payloads in one click", "Indent control (2/4 spaces or tabs)", "One-click copy and download of clean JSON"] },
  { slug: "hash-generator", name: "Hash Generator", description: "Generate MD5, SHA-1, SHA-256 hashes from any text.", icon: KeyRound, category: "developer-tools", tags: ["hash", "md5", "sha", "encrypt"], tier: "premium", premiumFeatures: ["MD5 + full SHA family (SHA-1/256/384/512)", "Live hashing as you type — no submit step", "Per-algorithm copy buttons", "Runs entirely in your browser"] },
